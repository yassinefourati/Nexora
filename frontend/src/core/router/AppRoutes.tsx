...
const CollectionCases    = lazy(() => import('@/features/collectionCases/pages/CollectionCases'));
const LoanNotifications  = lazy(() => import('@/features/loanNotifications/pages/LoanNotifications'));
  ...
  return (
    <Suspense fallback={<RouteSpinner />}>
      <Routes>
        ...
        <Route path={ROUTES.COLLECTION_CASES}              element={<Protected><CollectionCases /></Protected>} />
        <Route path={ROUTES.LOAN_NOTIFICATIONS}            element={<Protected><LoanNotifications /></Protected>} />
